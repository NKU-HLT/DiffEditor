...
def data_preprocess(file_path, input_directory, dictionary_path, acoustic_model_path, output_directory, align=True):
    ...
    print( f"{file_path},{input_directory},{dictionary_path},{acoustic_model_path}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default="DiffEditor")
    parser.add_argument('--config', type=str, default="egs/DiffEditor.yaml")
    ...
    # print(dataset_info)
    SpecDenoiserInfer.example_run([dataset_info],test_out_dir="out")

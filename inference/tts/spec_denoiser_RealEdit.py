...
class SpecDenoiserInfer(BaseTTSInfer):
    ...
    def forward_model(self, inp):
        ...
        if hparams['use_separate_encoder'] == True:
        ...
        #    
            ...
            output = self.model(edited_txt_tokens, time_mel_masks=time_mel_masks, mel2ph=edited_mel2ph, spk_embed=sample['spk_embed'],
                       ref_mels=ref_mels, f0=edited_f0, uv=edited_uv, energy=None, infer=True, use_pred_pitch=True,language_id=language_id)
...
if __name__ == '__main__':
    ...
    # use english_us_arpa to mfa
    test_file_path = 'RealEdit_audio/csv/RealEdit.csv'
    test_wav_directory = 'RealEdit_audio'
    ...
    output_directory = 'RealEdit_audio/mfa_out'
    test_out_dir = hparams['work_dir'].split('/')[1]+"_auto/RealEdit"

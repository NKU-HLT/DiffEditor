...
mfa align $BASE_DIR/mfa_inputs $BASE_DIR/mfa_dict2.txt $BASE_DIR/mfa_model.zip $BASE_DIR/mfa_outputs_tmp -t $BASE_DIR/mfa_tmp --clean -j $NUM_JOB --config_path data_gen/tts/mfa_train_config_aishell3.yaml
...
# source activate fluentspeech
# python data_gen/tts/base_binarizer.py --config egs/spec_denoiser_talcs.yaml